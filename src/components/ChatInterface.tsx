...
export default function ChatInterface() {
  ...
  return (
    <div className="h-screen relative overflow-hidden">
      ...
      <div className="absolute inset-0 bg-white dark:bg-gray-800 pt-16 sm:pt-20 pb-20 sm:pb-24">
        <MessageList />
      </div>
          ...
          <div className="flex items-center justify-between gap-4">
            ...
            <div className="flex items-baseline gap-2 justify-center flex-1">
              <a
                ...
                className="text-2xl sm:text-3xl font-bold text-gray-900 dark:text-gray-100 hover:text-blue-600 dark:hover:text-blue-400 transition-colors"
              >
                {t.aiTrioChat}
              </a>
              <a
      ...
      {!isSettingsOpen && (
        <div className="fixed bottom-0 left-0 right-0 z-10 bg-gray-50 dark:bg-gray-900 border-t border-gray-200 dark:border-gray-700 py-2 sm:py-4 px-2 sm:px-4">
          <div className="w-full lg:max-w-7xl lg:mx-auto">
            <ChatInput />
          </div>
        </div>
