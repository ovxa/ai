...
export default function ChatInterface() {
  ...
  return (
    <div className="h-screen relative overflow-hidden">
      ...
      <div className="absolute top-0 left-0 right-0 z-10 bg-gradient-to-b from-white via-white/95 to-transparent dark:from-gray-900 dark:via-gray-900/95 dark:to-transparent py-3 sm:py-4 px-4 sm:px-6 pb-16 sm:pb-20">
