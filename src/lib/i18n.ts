...
export const translations = {
  de: {
    ...
    more: 'Mehr',
    thinking: 'Denkt nach...',
    viewThinking: 'Denkprozess anzeigen',
    hideThinking: 'Denkprozess verbergen',
    save: 'Speichern',
    close: 'Schließen',
    ...
    selectPage: {
      title: 'AI-Assistenten auswählen',
      description: 'Wählen Sie die AI-Assistenten aus, die am Gruppenchat teilnehmen sollen.',
      selectAll: 'Alle auswählen',
      selectedCount: '{count}/{total} ausgewählt',
      startChat: 'Chat starten',
      tipsTitle: 'Tipps für Anfänger',
      tip1: 'Verwenden Sie @AI-Name, um eine bestimmte AI anzusprechen',
      tip2: 'Senden Sie direkt eine Nachricht und alle ausgewählten AIs werden antworten',
      tip3: 'Chatverlauf wird automatisch lokal im Browser gespeichert',
    },
    errors: {
  ...
  en: {
    ...
    selectPage: {
      title: 'Select AI Assistants',
      description: 'Choose the AI assistants you want to join your group chat.',
      selectAll: 'Select All',
      selectedCount: '{count}/{total} selected',
      startChat: 'Start Chat',
      tipsTitle: 'Tips for Beginners',
      tip1: 'Use @AI-name to ask a specific AI to respond',
      tip2: 'Send a message directly and all selected AIs will participate',
      tip3: 'Chat history is automatically saved locally in your browser',
    },
    errors: {
  ...
  es: {
    ...
    more: 'Más',
    thinking: 'Pensando...',
    viewThinking: 'Ver proceso de pensamiento',
    ...
    selectPage: {
      title: 'Seleccionar asistentes de IA',
      description: 'Elija los asistentes de IA que desea agregar al chat grupal.',
      selectAll: 'Seleccionar todo',
      selectedCount: '{count}/{total} seleccionados',
      startChat: 'Iniciar chat',
      tipsTitle: 'Consejos para principiantes',
      tip1: 'Use @nombre-AI para pedir a una IA específica que responda',
      tip2: 'Envíe un mensaje directamente y todas las IAs seleccionadas participarán',
      tip3: 'El historial de chat se guarda automáticamente en su navegador',
    },
    errors: {
  ...
  fr: {
    ...
    viewThinking: 'Voir le processus de réflexion',
    ...
    selectPage: {
      title: 'Sélectionner les assistants IA',
      description: 'Choisissez les assistants IA que vous souhaitez ajouter au chat de groupe.',
      selectAll: 'Tout sélectionner',
      selectedCount: '{count}/{total} sélectionnés',
      startChat: 'Démarrer le chat',
      tipsTitle: 'Conseils pour les débutants',
      tip1: 'Utilisez @nom-IA pour demander à une IA spécifique de répondre',
      tip2: 'Envoyez un message directement et toutes les IAs sélectionnées participeront',
      tip3: "L'historique du chat est automatiquement enregistré dans votre navigateur",
    },
    errors: {
  ...
  it: {
    ...
    viewThinking: 'Visualizza processo di pensiero',
    hideThinking: 'Nascondi processo di pensiero',
    save: 'Salva',
    close: 'Chiudi',
    ...
    selectPage: {
      title: 'Seleziona assistenti AI',
      description: 'Scegli gli assistenti AI che vuoi aggiungere alla chat di gruppo.',
      selectAll: 'Seleziona tutto',
      selectedCount: '{count}/{total} selezionati',
      startChat: 'Avvia chat',
      tipsTitle: 'Suggerimenti per principianti',
      tip1: 'Usa @nome-AI per chiedere a una specifica AI di rispondere',
      tip2: 'Invia un messaggio direttamente e tutte le AI selezionate parteciperanno',
      tip3: 'La cronologia delle chat viene salvata automaticamente nel browser',
    },
    errors: {
  ...
  ja: {
    ...
    more: 'もっと見る',
    thinking: '考え中...',
    viewThinking: '思考過程を表示',
    hideThinking: '思考過程を隠す',
    save: '保存',
    close: '閉じる',
    ...
    selectPage: {
      title: 'AIアシスタントを選択',
      description: 'グループチャットに参加させるAIアシスタントを選んでください。',
      selectAll: 'すべて選択',
      selectedCount: '{count}/{total} 選択済み',
      startChat: 'チャットを開始',
      tipsTitle: '初心者向けヒント',
      tip1: '@AI名 を使用して特定のAIに返答を依頼できます',
      tip2: 'メッセージを直接送信すると、選択したすべてのAIが参加します',
      tip3: 'チャット履歴はブラウザにローカル保存されます',
    },
    errors: {
  ...
  ko: {
    ...
    more: '더 보기',
    thinking: '생각 중...',
    viewThinking: '생각 과정 보기',
    hideThinking: '생각 과정 숨기기',
    save: '저장',
    close: '닫기',
    ...
    selectPage: {
      title: 'AI 어시스턴트 선택',
      description: '그룹 채팅에 참여할 AI 어시스턴트를 선택하세요.',
      selectAll: '모두 선택',
      selectedCount: '{count}/{total} 선택됨',
      startChat: '채팅 시작',
      tipsTitle: '초보자 팁',
      tip1: '@AI이름 을 사용하여 특정 AI에게 응답을 요청하세요',
      tip2: '메시지를 직접 보내면 선택한 모든 AI가 참여합니다',
      tip3: '채팅 기록은 브라우저에 자동으로 저장됩니다',
    },
    errors: {
  ...
  pt: {
    ...
    more: 'Mais',
    thinking: 'Pensando...',
    viewThinking: 'Ver processo de pensamento',
    ...
    selectPage: {
      title: 'Selecionar assistentes de IA',
      description: 'Escolha os assistentes de IA que você deseja adicionar ao chat em grupo.',
      selectAll: 'Selecionar tudo',
      selectedCount: '{count}/{total} selecionados',
      startChat: 'Iniciar chat',
      tipsTitle: 'Dicas para iniciantes',
      tip1: 'Use @nome-da-IA para pedir a uma IA específica para responder',
      tip2: 'Envie uma mensagem diretamente e todas as IAs selecionadas participarão',
      tip3: 'O histórico do chat é salvo automaticamente no seu navegador',
    },
    errors: {
  ...
  zh: {
    ...
    selectPage: {
      title: '选择 AI 助手',
      description: '选择您想要加入群聊的 AI 助手。选中的 AI 将在对话中为您提供帮助。',
      selectAll: '全选',
      selectedCount: '已选择 {count}/{total}',
      startChat: '开始聊天',
      tipsTitle: '新手提示',
      tip1: '使用 @AI名称 可以指定某个 AI 回复你的问题',
      tip2: '直接发送消息，所有选中的 AI 都会参与讨论',
      tip3: '聊天记录会自动保存在本地浏览器中',
    },
    errors: {
  ...
  ru: {
    ...
    more: 'Ещё',
    thinking: 'Думаю...',
    viewThinking: 'Показать ход мыслей',
    ...
    selectPage: {
      title: 'Выберите ИИ-ассистентов',
      description: 'Выберите ИИ-ассистентов, которых хотите добавить в групповой чат.',
      selectAll: 'Выбрать все',
      selectedCount: '{count}/{total} выбрано',
      startChat: 'Начать чат',
      tipsTitle: 'Советы для начинающих',
      tip1: 'Используйте @имя-ИИ, чтобы попросить конкретного ИИ ответить',
      tip2: 'Отправьте сообщение напрямую, и все выбранные ИИ будут участвовать',
      tip3: 'История чата автоматически сохраняется в вашем браузере',
    },
    errors: {
