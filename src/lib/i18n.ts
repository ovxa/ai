...
export const translations = {
  de: {
    ...
    navigationHint: '↑↓ Navigation • Enter Auswählen • Esc Schließen',
    modelSettings: {
  ...
  es: {
    ...
    navigationHint: '↑↓ Navegar • Enter Seleccionar • Esc Cerrar',
    modelSettings: {
  ...
  fr: {
    ...
    navigationHint: '↑↓ Naviguer • Enter Sélectionner • Esc Fermer',
    modelSettings: {
  ...
  it: {
    ...
    navigationHint: '↑↓ Naviga • Enter Seleziona • Esc Chiudi',
    modelSettings: {
  ...
  ja: {
    ...
    navigationHint: '↑↓ ナビゲート • Enter 選択 • Esc 閉じる',
    modelSettings: {
      title: 'モデル & API 設定',
  ...
  ko: {
    ...
    navigationHint: '↑↓ 탐색 • Enter 선택 • Esc 닫기',
    modelSettings: {
      title: '모델 & API 설정',
  ...
  pt: {
    ...
    navigationHint: '↑↓ Navegar • Enter Selecionar • Esc Fechar',
    modelSettings: {
  ...
  ru: {
    ...
    navigationHint: '↑↓ Навигация • Enter Выбрать • Esc Закрыть',
    modelSettings: {
