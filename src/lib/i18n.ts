...
export const translations = {
  de: {
    ...
    theme: 'Thema',
    sequentialMode: 'Sequenzieller Modus',
    sequentialModeDescription: 'AIs antworten nacheinander (für Geräte mit geringer Leistung)',
    more: 'Mehr',
    save: 'Speichern',
    close: 'Schließen',
  ...
  en: {
    ...
    sequentialModeDescription: 'AIs respond one at a time (for low-power devices)',
    more: 'More',
    save: 'Save',
    close: 'Close',
  ...
  es: {
    ...
    theme: 'Tema',
    sequentialMode: 'Modo Secuencial',
    sequentialModeDescription: 'Las IAs responden una a la vez (para dispositivos de baja potencia)',
    more: 'Más',
    save: 'Guardar',
    close: 'Cerrar',
  ...
  fr: {
    ...
    settings: 'Paramètres',
    theme: 'Thème',
    sequentialMode: 'Mode Séquentiel',
    sequentialModeDescription: 'Les IAs répondent une par une (pour appareils à faible puissance)',
    more: 'Plus',
    save: 'Enregistrer',
    close: 'Fermer',
  ...
  it: {
    ...
    theme: 'Tema',
    sequentialMode: 'Modalità Sequenziale',
    sequentialModeDescription: 'Le IA rispondono una alla volta (per dispositivi a bassa potenza)',
    more: 'Altro',
    save: 'Salva',
    close: 'Chiudi',
  ...
  ja: {
    ...
    settings: '設定',
    theme: 'テーマ',
    sequentialMode: 'シーケンシャルモード',
    sequentialModeDescription: 'AIが順番に応答（低電力デバイス向け）',
    more: 'もっと見る',
    save: '保存',
    close: '閉じる',
  ...
  ko: {
    ...
    sequentialModeDescription: 'AI가 순차적으로 응답 (저전력 기기용)',
    more: '더 보기',
    save: '저장',
    close: '닫기',
  ...
  pt: {
    ...
    theme: 'Tema',
    sequentialMode: 'Modo Sequencial',
    sequentialModeDescription: 'IAs respondem uma de cada vez (para dispositivos de baixa potência)',
    more: 'Mais',
    save: 'Salvar',
    close: 'Fechar',
  ...
  zh: {
    ...
    theme: '主题',
    sequentialMode: '顺序模式',
    sequentialModeDescription: 'AI 依次回复（适用于低功耗设备）',
    more: '更多',
    save: '保存',
    close: '关闭',
  ...
  ru: {
    ...
    sequentialModeDescription: 'ИИ отвечают по очереди (для маломощных устройств)',
    more: 'Ещё',
    save: 'Сохранить',
    close: 'Закрыть',
